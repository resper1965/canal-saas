  ...
  return (
    <div ref={ref} className="relative w-full">
      ...
      <button
        ...
        className="w-full flex items-center justify-between gap-2 px-2 py-2 rounded-lg hover:bg-muted/50 transition-colors"
      >
      ...
      {/* Dropdown panel */}
      {open && (
        <div className="absolute bottom-[calc(100%+8px)] left-0 right-0 z-100 rounded-xl border border-border bg-card shadow-lg overflow-hidden animate-in fade-in slide-in-from-bottom-2 duration-200">
          ...
          <div className="p-2 space-y-1">
            <button
              ...
              className="w-full flex h-11 items-center gap-3 px-4 rounded-xl text-[11px] font-bold uppercase tracking-widest text-zinc-400 hover:bg-muted/50 hover:text-white transition-all"
            >
